...
const Home = () => {
  ...
  function handleBtnEntrarClick() {
    navigation.navigate('CollectPoint', { uf, city })
  }
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ImageBackground source={require("./../../assets/home-background.png")} style={styles.container} imageStyle={{ width: 274, height: 368 }}>
        ...
        <View style={styles.footer}>
          <TextInput style={styles.input} placeholder='Digite a UF' maxLength={2} autoCorrect={false} autoCapitalize='characters' value={uf} onChangeText={setUF} />
          <TextInput style={styles.input} placeholder='Digite a Cidade' autoCorrect={false} value={city} onChangeText={setCity} />
          <RectButton style={styles.button} onPress={handleBtnEntrarClick}>
